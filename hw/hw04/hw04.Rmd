...
### Instructions 
* Solutions will be released on Tuesday, February 23
...
9) [2 points] Without using the number of co-infections provided in the question (that is: do not use the value 300,000),
