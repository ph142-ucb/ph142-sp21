...
```
### Announcements
- Remember to meet with your supporting GSI regarding your data project - meeting with your GSI at least once by April 23rd to talk about Part III This will count as a participation point.  
- Official course evaluations (usually sent out around the 20th of April) are very important to us.  If you submit a screen shot of your completion report that shows your name and the course number (not the actual evaluation) you will receive an extra credit point on the final.  If the course reaches a 90% response rate I will add an extra point to everyone's final exam.  
- Bootstrapping will be considered bonus material and only included in quiz/exams for extra credit, however the terms from Epi will be considered fair game for testing.


### Goals for today
- Go over another "recipe" for creating confidence intervals (bootstrap)
- Introduce some terms from Epidemiology
  - Risk difference
  - Risk ratio
  - Odds ratio

**note, bootstraping is not in your textbook, and the way your book describes the epidemiologic terms is not consistent with the way we teach them at Berkeley.  For these topics lecture materials supersede the textbook.  
