...
### Instructions 
* Due date: Tuesday, February 2 at 10:00pm PST with 2 hour grace period.
...
**6. Because `Income_Group` and `Region` are categorical, we make bar charts to represent their distributions. Using the `ggplot()` code you learnt during lecture, make a bar chart showing the number of countries per income group using `Income_Group`.**
...
cd; cd ph142-sp21/lab/lab02; python3 turn_in.py
